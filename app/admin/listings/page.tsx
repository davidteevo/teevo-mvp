...
export default async function AdminListingsPendingPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-mowing-green">Verify listings</h1>
      <p className="mt-1 text-mowing-green/80">Approve or reject so items can be purchased. Flag suspicious items.</p>
      <div className="mt-6">
