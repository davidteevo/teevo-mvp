...
const ALLOWED_EVENTS = [
  ...
  "creator_hub_viewed",
  "creator_hub_quick_nav",
  "creator_quick_tool_clicked",
  "creator_share_clicked",
  "creator_link_shared",
  "creator_link_copied",
  "creator_whatsapp_clicked",
  "creator_caption_copied",
  "creator_message_copied",
  "creator_content_copied",
  "creator_content_shared",
  "creator_mission_cta_clicked",
  "creator_brand_pack_opened",
  "creator_onboarding_email_sent",
  "creator_referrals_viewed",
  "creator_squad_viewed",
  "creator_earnings_viewed",
  "creator_activity_viewed",
  "admin_creator_added",
  "admin_creator_removed",
  "admin_creator_insights_viewed",
  "admin_creator_link_copied",
