...
export async function GET() {
  ...
  const fullSelect = "id, email, role, avatar_path, display_name, first_name, surname, location, handicap, handed, address_line1, address_line2, address_city, address_postcode, address_country, date_of_birth, founding_seller_rank, founder_joined_at, founder_reward_status, founder_reward_earned_at, founder_reward_listing_id, created_at, updated_at";
