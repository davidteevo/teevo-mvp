...
-- Listing-level extensions (nullable for backwards compatibility)
...
-- Default existing golf-equipment rows to single when format is null (display layer treats null as single).
...
-- Child clubs for wedge sets (and future multi-club listings)
