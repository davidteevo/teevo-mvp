...
BEGIN
  ...
  -- Only platform admins are excluded; admin-created sellers/creators are eligible
...
-- Backfill current creators into any remaining Founder spots (campaign must be active).
DO $$
DECLARE
  r RECORD;
BEGIN
