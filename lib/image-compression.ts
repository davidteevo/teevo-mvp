...
/** Main listing image: max 1600px width, WebP, ~72% quality. For detail page / buyer view. */
const MAIN_MAX_WIDTH = 1600;
const MAIN_QUALITY = 0.72;
const MAIN_MAX_SIZE_MB = 0.6;

/** Thumbnail: 400px width, WebP, ~65% quality. For grids only. */
const THUMB_MAX_WIDTH = 400;
const THUMB_QUALITY = 0.65;
const THUMB_MAX_SIZE_MB = 0.12;

/**
 * Compress a file to main listing image (1600px, WebP, ~300–500KB target).
...
/**
 * Compress a file to thumbnail (400px, WebP, ~50–100KB target).
