...
export async function createTransactionAndSendEmails(
  ...
  if (sellerEmail) {
    await ensureEmailSent(admin, {
      ...
      to: sellerEmail,
      subject: `\uD83C\uDF89 You sold your ${itemName}!`,
      type: "transactional",
      variables: {
        title: `Great news \u2014 your ${itemName} has sold!`,
        subtitle: `The buyer has paid. Please ship by ${deadlineLabel}.`,
        body: [
          `It\u2019s over to you now. Please get your club packaged up and ready to ship by <strong>${deadlineLabel}</strong>.`,
          ``,
          `<strong>Next up:</strong>`,
          `1. Pack your club securely.`,
          `2. Follow the shipping steps in your Teevo Sales dashboard.`,
          `3. Get it on its way to its new owner.`,
          ``,
          `If you don\u2019t dispatch the order by ${deadlineLabel}, the order may be automatically cancelled and the buyer refunded.`,
          ``,
          `We\u2019ll keep you updated along the way, and your funds will be released once the order is successfully completed.`,
    ...
    await ensureEmailSent(admin, {
      ...
      recipientId: sellerId,
      to: sellerEmail,
      subject: "\uD83D\uDCB8 Payment received \u2014 nice one!",
      type: "transactional",
      variables: {
