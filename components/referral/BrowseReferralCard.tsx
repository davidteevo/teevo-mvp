...
function RewardTile({ amount, label }: { amount: string; label: string }) {
  return (
    <div className="relative flex min-w-[4.75rem] flex-col items-center rounded-xl border border-golden-tee/60 bg-off-white-pique px-3 py-2 shadow-sm sm:min-w-[5.5rem] sm:px-4 sm:py-2.5">
    ...
    <div className="relative flex flex-col items-center justify-center gap-2">
      {showAvatars && (
        <div className="relative flex items-center gap-2.5" aria-hidden>
          <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border-2 border-golden-tee/40 bg-off-white-pique/15">
            <svg viewBox="0 0 40 40" className="h-full w-full" aria-hidden>
              <circle cx="20" cy="15" r="7" fill="#FDFCF5" opacity="0.7" />
              <ellipse cx="20" cy="32" rx="12" ry="10" fill="#FDFCF5" opacity="0.45" />
            </svg>
          </div>
          <div className="relative flex w-11 items-center justify-center">
            <div className="absolute inset-x-0 top-1/2 h-px border-t border-dashed border-golden-tee/50" />
            <span className="absolute right-0 top-1/2 -translate-y-1/2 text-golden-tee/80">›</span>
            <div className="relative z-10 rounded-full bg-off-white-pique p-0.5 shadow-sm">
              <Image
                src="/logo-icon.png"
                alt=""
                width={22}
          ...
          <div className="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border-2 border-golden-tee/70 bg-golden-tee/25">
            <svg viewBox="0 0 40 40" className="h-full w-full" aria-hidden>
              <path
                ...
                opacity="0.45"
              />
              <circle cx="20" cy="16" r="7" fill="#FDFCF5" opacity="0.7" />
              <ellipse cx="20" cy="33" rx="12" ry="9" fill="#FDFCF5" opacity="0.45" />
            </svg>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center gap-2 sm:gap-2.5">
        ...
        <span className="text-xl font-bold text-golden-tee" aria-hidden>
          +
        </span>
...
export function BrowseReferralCard({
  ...
  return (
    <section
      className="relative mb-6 overflow-hidden rounded-2xl border border-golden-tee/40 bg-gradient-to-br from-mowing-green to-mowing-green/90 px-4 py-3.5 text-off-white-pique shadow-sm sm:px-6 sm:py-4"
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute -bottom-10 -left-6 h-24 w-24 rounded-full bg-golden-tee/10"
        aria-hidden
      />

      <h2 id="browse-referral-heading" className="sr-only">
        Refer a friend — {themAmount} for them, {youAmount} for you
      </h2>
      ...
      <div className="relative grid gap-3 md:grid-cols-[minmax(0,1.2fr)_minmax(0,0.9fr)] md:items-center md:gap-5">
        <div className="min-w-0">
          ...
          <p className="mt-2.5 text-sm leading-snug text-off-white-pique/80 md:mt-0">
            {body}
          </p>
          ...
          <Link
            ...
            className="group mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-golden-tee px-4 py-2.5 text-sm font-semibold text-mowing-green motion-safe:transition-[transform,opacity] motion-safe:duration-200 hover:opacity-95 motion-safe:hover:-translate-y-0.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-golden-tee sm:w-auto"
          >
            Refer a friend
            <ArrowRight
